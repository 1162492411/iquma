                            ...
                            <div class="List-item">
                                ...
                                <div class="ContentItem">
                                    <h2 class="ContentItem-title">
                                        <a href="${pageContext.request.contextPath}/tutorial/${favorite.obid}">${favorite.topic.title}</a>
                                    </h2>
                                    <!-- 查看按钮 -->
                                    <div class="ContentItem-content is-collapsed">
                                        <span class="RichText CopyrightRichText-richText">${favorite.topic.content}</span>
                                        <a class="Button ContentItem-more Button--plain"
                                           type="button"
                                           href="${pageContext.request.contextPath}/tutorial/${favorite.obid}">
                                            查看
                                        </a>
                                    </div><!-- 阅读按钮结束 -->
                                </div> <!-- 回复信息结束 -->
