...
<head>
    ...
    <script type="text/javascript">
        function deleteArticle(id){
            $.ajax({
                type: 'delete',
                url:'${pageContext.request.contextPath}/article/'+id,
                dataType:'text',
...
<div class="panel panel-default" style="width:60%;height:40%;position:absolute;left:20%;top:20%">
    <div class="panel-heading">
        ...
        作者:${article.aid} &emsp;&emsp;&emsp;&emsp;发表时间:${article.addTime}
    </div>
    <div class="panel-body">
        ${article.content}
        <br />
        <a href="/article/${article.id}/update">
...
<div class="panel panel-default" style="position:absolute;left:20%;top:100%">
    <form action="/article/${article.id}/reply" method="post">
        ...
        <input type="hidden" name="tid" value="${article.id}"/><br /><br />
