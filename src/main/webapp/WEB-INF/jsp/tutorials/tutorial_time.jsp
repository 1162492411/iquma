...
<!-- 隐藏数据区 -->
<div>
    <input type="hidden" id="condition_tid" value="${tutorial.id}"/>
    <input type="hidden" id="condition_isBlock" value="${tutorial.isBlock}"/>
    <input type="hidden" id="topicTitle" value="${tutorial.title}"/>
    <input type="hidden" id="condition_uid" value="${userid}" />
    <input type="hidden" id="condition_aid" value="${tutorial.aid}"/>
</div><!-- 隐藏数据区结束 -->
<%--<!-- 主数据区 -->--%>
<main role="main">
    <div class="wrap">
                    ...
                    <div class="col-md-9 col-sm-8 col-xs-12">
                        ...
                        <div class="post-topheader__info">
                            <h1 class="h3 post-topheader__info--title" id="questionTitle">
                                <a href="${pageContext.request.contextPath}/tutorial/${tutorial.id}">${tutorial.title}</a>
                            </h1>
                            ...
                            <div class="question__author">
                                <a href="${pageContext.request.contextPath}/user/${tutorial.aid}/home" class="mr5">
                                    <strong>${tutorial.user.name}</strong>
                                </a>
                ...
                <div class="col-xs-12 col-md-9 main">
                    <article class="widget-question__item">
                        <div class="post-col">
                            <div class="widget-vote  ">
                                ...
                                <span class="count">${tutorial.rateCount}</span>
                            ...
                            <div class="row">
                                <div class="post-opt col-md-8">
                                    <ul class="list-inline mb0">
                                        <li><strong class="no-stress">${tutorial.viewCount}</strong> 浏览</li>
                                        <li><a>
                                            <fmt:formatDate value="${tutorial.addTime}"
                                                            pattern="yyyy-MM-dd"/>
                                        </a></li>
                                        <shiro:hasPermission name="tutorial:update:${tutorial.id}">
                                            <a href="${pageContext.request.contextPath}/tutorial/${tutorial.id}/update">
                                                <Button class="btn btn-primary">编辑</Button>
                                            </a>
                                            </li>
                                        </shiro:hasPermission>
                                        <shiro:hasPermission name="tutorial:block:${tutorial.id}">
                                            <li>
                                                <Button class="btn btn-primary" id="blockButton" onclick="blockTopic('tutorial')" disabled>关闭</Button>
                                            </li>
                                        </shiro:hasPermission>
                                        <shiro:hasPermission name="tutorial:delete:${tutorial.id}">
                                            <li>
                                                <Button class="btn btn-danger"
                                                        onclick="deleteTopic('tutorial')">删除</Button>
                                            </li>
                                        </shiro:hasPermission>
                                        <shiro:user>
                                            <li>
                                                <Button class="btn btn-primary" id="favoriteButton" onclick="favoriteTopic('tutorial')" disabled>收藏</Button>
                                            </li>
                                        </shiro:user>
                                    </ul>
                                </div>
                    ...
                    <div class="widget-answers" id="repliesDiv">
                        ...
                        <div class="btn-group pull-right" role="group">
                            <a href="${pageContext.request.contextPath}/tutorial/${tutorial.id}"
                                class="btn btn-default btn-xs">默认排序</a>
