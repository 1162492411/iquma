...
<head>
	...
	<script charset="utf-8" src="${pageContext.request.contextPath}/static/kindeditor.js"></script>
	...
	<script>
		KindEditor.ready(function(K) {
			var editor1 = K.create('textarea[name="content1"]', {
				cssPath : '${pageContext.request.contextPath}/static/plugins/code/prettify.css',
