...
<%-- 修改教程 --%>
    <%-- 用户具有修改主贴的权限时显示页面 --%>
    <shiro:hasPermission name="${topic.section.name}:update">
        <form id="updateTopicForm" >
            <div class="panel panel-default">
                ...
                <div class="panel-body" id="topicPanel">
                    ...
                    <input type="hidden" name="section.name" id="sectionname" value="${topic.section.name}" />
                    <%--主贴标题 --%>
                    ...
                    <div class="form-group" id="buttonPanel">
                        <input type="button" id="updateButton" class="btn btn-primary" onclick="updateTopic('${topic.section.name}')"  value="修改"/>
    ...
    <%-- 用户没有修改该主贴的权限时 --%>
    <shiro:lacksPermission name="${topic.section.name}:update">
        <%-- 如果该贴是用户自己的主贴时显示页面内容 --%>
